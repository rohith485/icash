...
import com.icashflow.batch.item.excel.RowMapper;
...
public class BeanWrapperRowMapper<T> extends DefaultPropertyEditorRegistrar implements RowMapper<T>, BeanFactoryAware, InitializingBean {
     ...
     * that will be passed into {@link #mapRow(com.icashflow.batch.item.excel.support.rowset.RowSet)}. Typically a
     ...
     * for every call to {@link #mapRow(com.icashflow.batch.item.excel.support.rowset.RowSet)}.<br>
     *
